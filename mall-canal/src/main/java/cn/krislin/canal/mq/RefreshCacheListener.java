package cn.krislin.canal.mq;

import cn.krislin.canal.domain.PmsProductParam;
import cn.krislin.canal.util.ClassUtil;
import cn.krislin.canal.util.RedisOpsUtil;
...
/**
 * 产品表信息修改-同步更新到Redis-Cache,ELK,Hadoop,相关下游服务
 **/
@Slf4j
@Component
